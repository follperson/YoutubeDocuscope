...
##
rbind(head(key_shakes, n=10), tail(key_shakes, n=10))
...
# 'the' is a keyword of action movies!!! very concrete based, not relational
# uh , i , she, oh  - general speech tags
##
...
# 
# collocation 
# register variation between the two
# 
